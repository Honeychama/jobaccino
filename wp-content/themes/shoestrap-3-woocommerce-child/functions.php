...
if ( shoestrap_getvariable( 'always_compile_less' ) == 0 ) {


	// Render if either the timestamp file doesn't exist, or the modified time of the less file is greater than the timestamp

	if ( !file_exists(get_stylesheet_directory() . '/assets/less/last_rendered') || ( filemtime(get_stylesheet_directory() . '/assets/less/my-styles.less') > file_get_contents(get_stylesheet_directory() . '/assets/less/last_rendered') ) ) {
		...
		file_put_contents(get_stylesheet_directory() . '/assets/less/last_rendered', filemtime(get_stylesheet_directory() . '/assets/less/my-styles.less'));
